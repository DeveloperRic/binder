...
const TOKEN_PATH = "server_data/app.server.source.dropbox.credentials.json";
...
exports.init = function() {
  ...
  fs.readFile(
    "server_data/app.server.source.dropbox.client_secret.json",
    (err, content) => {
      if (err) {
        if (err.code == "ENOENT") {
          return console.log("Couldn't find dropbox client secret!");
        } else {
          return console.log("Error loading dropbox client secret file: ", err);
        }
      }
